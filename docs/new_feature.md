...
|---|---------|------|---------|---------|
| 1 | 特徴量追加 | レース内相対特徴量 | ★★★★★ | 中 |
| 2 | 特徴量追加 | レースラップ・ペース特徴量 | ★★★★ | 中 |
| 3 | 特徴量追加 | JRA-VANデータマイニング予想の活用 | ★★★★ | 低 |
| 4 | 特徴量改善 | 直近走の「重み付き」成績集計 | ★★★★ | 低 |
| 5 | 特徴量追加 | 票数（投票比率）ベースの特徴量 | ★★★★ | 中 |
| 6 | 特徴量追加 | 時系列オッズの変動特徴量 | ★★★ | 中 |
| 7 | 特徴量追加 | 馬主・生産者の成績特徴量 | ★★★ | 低 |
| 8 | 特徴量改善 | 血統特徴量の強化（母系、ニックス） | ★★★ | 中 |
| 9 | 特徴量追加 | コース区分（A/B/C/D）の活用 | ★★★ | 低 |
| 10 | 特徴量追加 | 競走馬セール価格 | ★★ | 低 |
| 11 | 特徴量改善 | 調教特徴量の強化 | ★★★ | 中 |
| 12 | モデル改善 | 目的変数の多様化（LambdaRank等） | ★★★★★ | 高 |
| 13 | モデル改善 | 確率キャリブレーション | ★★★★ | 低 |
| 14 | モデル改善 | 特徴量自動選択パイプライン | ★★★ | 中 |
| 15 | モデル改善 | オッズ有無の2モデル体制 | ★★★ | 中 |
| 16 | 特徴量追加 | 賞金ベース特徴量 | ★★★ | 低 |
| 17 | 特徴量追加 | 枠順×コース適性クロス特徴量 | ★★★ | 中 |
